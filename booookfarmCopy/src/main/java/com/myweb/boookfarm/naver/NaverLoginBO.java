...
public class NaverLoginBO {
    ...
    private final static String CLIENT_ID = "Tw0oabeZaEROMZorySYP"; // 클라이언트 아이디
    private final static String CLIENT_SECRET = "lt3Hkoqq90"; // 클라이언트 시크릿
    private final static String REDIRECT_URI = "http://localhost:8080/boookfarm/callbackNaver";
